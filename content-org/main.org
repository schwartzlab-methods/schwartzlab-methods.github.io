...
Biology. [[https://www.uhnresearch.ca/news/research-chairs-awarded][Read more about the award at UHN]] and [[https://www.chairs-chaires.gc.ca/whats_new-quoi_de_neuf/2022/crc-2021-2-eng.aspx][the Chairs website]].

** Lin Yang joins the lab as a PhD student!
SCHEDULED: <2023-01-02 Mon>
:PROPERTIES:
:EXPORT_FILE_NAME: lin_joins_2023-01-03
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :banner "img/news/join_lab.png"
:END:
Lin Yang from the Department of Medical Biophysics joins the lab.

** Almas Khan joins the lab as a PhD student!
SCHEDULED: <2023-01-02 Mon>
:PROPERTIES:
:EXPORT_FILE_NAME: almas_joins_2023-01-03
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :banner "img/news/join_lab.png"
:END:
Almas Khan from the Department of Medical Biophysics joins the lab.

** We have a new website: https://schwartzlab.ca/
SCHEDULED: <2023-06-21 Wed>
:PROPERTIES:
:EXPORT_FILE_NAME: new_website_2023-06-21
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :banner "img/news/newspaper.png"
:END:
